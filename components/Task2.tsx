    ...
    <Pressable
      ...
      <View
        ...
        <View
          ...
          <Text style={{ flex: 1, fontFamily: fonts.bold, fontSize: 18 }}>
            {title}
          </Text>
        ...
        <View
          ...
          <View style={styles.icons}>
            <View
              ...
              <EvilIcons name="location" color={Colors.secondary} size={15} />
            </View>
          ...
          <View style={styles.icons}>
            ...
            <Text style={styles.subs}>{date ? getFullDate(date) : "  "}</Text>
          </View>
        </View>
        <View
          style={{
